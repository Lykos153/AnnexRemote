...
class TestGitAnnexRequestMessages(utils.GitAnnexTestCase):
    ...
    def TestInitremoteSuccess(self):
        self.annex.Listen(six.StringIO(u"INITREMOTE"))
    ...
    def TestExtensions(self):
        self.annex.Listen(six.StringIO(u"EXTENSIONS Annex1 Annex2"))
        self.assertEqual(utils.second_buffer_line(self.output), "EXTENSIONS")  
        
    def TestPrepareSuccess(self):
        self.annex.Listen(six.StringIO(u"PREPARE"))
    ...
    def TestTransferStoreSuccess(self):
        self.annex.Listen(six.StringIO(u"TRANSFER STORE Key File"))
    ...
    def TestTransferStoreMissingFilename(self):
        with self.assertRaises(SyntaxError):
            self.annex.Listen(six.StringIO(u"TRANSFER STORE Key"))

    def TestTransferStore_SpaceInFilename(self):
        self.annex.Listen(six.StringIO(u"TRANSFER STORE Key File with spaces"))
        self.remote.transfer_store.assert_called_once_with("Key", "File with spaces")

    def TestTransferRetrieveSuccess(self):
        self.annex.Listen(six.StringIO(u"TRANSFER RETRIEVE Key File"))
    ...
    def TestTransferRetrieve_MissingFilename(self):
        with self.assertRaises(SyntaxError):
            self.annex.Listen(six.StringIO(u"TRANSFER RETRIEVE Key"))

    def TestTransferRetrieve_SpaceInFilename(self):
        self.annex.Listen(six.StringIO(u"TRANSFER RETRIEVE Key File with spaces"))
    ...
    def TestCheckpresentSuccess(self):
        ...
        self.annex.Listen(six.StringIO(u"CHECKPRESENT Key"))
    ...
    def TestRemoveSuccess(self):
        self.annex.Listen(six.StringIO(u"REMOVE Key"))
    ...
    def TestGetcost(self):
        ...
        self.annex.Listen(six.StringIO(u"GETCOST"))
    ...
    def TestGetavailabilityGlobal(self):
        ...
        self.annex.Listen(six.StringIO(u"GETAVAILABILITY"))
    ...
    def TestClaimurlSuccess(self):
        ...
        self.annex.Listen(six.StringIO(u"CLAIMURL Url"))
    ...
    def TestCheckurlContents(self):
        ...
        self.annex.Listen(six.StringIO(u"CHECKURL Url"))
    ...
    def TestWhereisSuccess(self):
        ...
        self.annex.Listen(six.StringIO(u"WHEREIS Key"))
    ...
    def TestGetinfo(self):
        ...
        self.annex.Listen(six.StringIO(u"GETINFO"))
...
class TestGitAnnexRequestMessagesExporttree(utils.GitAnnexTestCase):
    def TestExportsupportedSuccess(self):
        self.annex.Listen(six.StringIO(u"EXPORTSUPPORTED"))
    ...
    def TestTransferexportStoreSuccess(self):
        self.annex.Listen(six.StringIO(u"EXPORT Name\nTRANSFEREXPORT STORE Key File"))
    ...
    def TestTransferexportStore_WithoutExport(self):
        with self.assertRaises(ProtocolError):
            self.annex.Listen(six.StringIO(u"TRANSFEREXPORT STORE Key"))
    ...
    def TestTransferexportRetrieve_WithoutExport(self):
        with self.assertRaises(ProtocolError):
            self.annex.Listen(six.StringIO(u"TRANSFEREXPORT RETRIEVE Key"))
    ...
    def TestCheckpresentexport_WithoutExport(self):
        with self.assertRaises(ProtocolError):
            self.annex.Listen(six.StringIO(u"CHECKPRESENTEXPORT Key"))
    ...
    def TestRemoveexport_WithoutExport(self):
        with self.assertRaises(ProtocolError):
            self.annex.Listen(six.StringIO(u"REMOVEEXPORT Key"))

    def TestRemoveexportdirectorySuccess(self):
        self.annex.Listen(six.StringIO(u"REMOVEEXPORTDIRECTORY Directory"))
    ...
    def TestRemoveexportdirectory_MissingDirectory(self):
        with self.assertRaises(SyntaxError):
            self.annex.Listen(six.StringIO(u"REMOVEEXPORTDIRECTORY"))

    def TestRemoveexportdirectory_SpaceInFilename(self):
        self.annex.Listen(six.StringIO(u"REMOVEEXPORTDIRECTORY Directory with spaces"))
    ...
    def TestRenameexport_WithoutExport(self):
        with self.assertRaises(ProtocolError):
            self.annex.Listen(six.StringIO(u"RENAMEEXPORT Key NewName"))
...
class TestUnsupportedRequests(utils.MinimalTestCase):
    def TestUnsupportedRequest(self):
        self.annex.Listen(six.StringIO(u"Not a request"))
